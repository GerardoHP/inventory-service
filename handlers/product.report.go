...
func NewProductReportHandler() *ProductReport {
	return &ProductReport{}
}

var _ http.Handler = (*ProductReport)(nil)

func (p *ProductReport) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	switch r.Method {
	case http.MethodPost:
		var productFilter models.ProductReportFilter
		...
		products, err := repository.SearchForProductData(productFilter)
		if err != nil {
			log.Println(err)
